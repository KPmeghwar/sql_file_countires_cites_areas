...
--
-- Host: localhost
-- Generation Time: Jul 27, 2024 at 05:48 PM
...
CREATE TABLE `countries` (
  ...
  `iso` varchar(2) COLLATE utf8mb3_unicode_ci NOT NULL,
  `iso3` varchar(3) COLLATE utf8mb3_unicode_ci NOT NULL,
  `dial` varchar(5) COLLATE utf8mb3_unicode_ci NOT NULL,
  `currency` varchar(3) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `currency_name` varchar(60) COLLATE utf8mb3_unicode_ci DEFAULT NULL
...
INSERT INTO `countries` (`country_id`, `name`, `iso`, `iso3`, `dial`, `currency`, `currency_name`) VALUES
...
--
ALTER TABLE `countries`
  MODIFY `country_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250;
COMMIT;
